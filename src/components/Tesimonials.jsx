...
const Tesimonials = () => {
  return (
    <div>
      <Title title='What Our Guest Say ' subtitle="Discover why discerning travelers consistently choose QuickStay for their exclusiv and luxurious accomodation around the world"/>



      <div className="flex flex-wrap items-center justify-center gap-6 my-10 mb-20 pt-14">
    <div className="text-sm w-80 border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
        ...
        <p className="text-gray-500 px-6 text-center">I've been using QuickStay for nearly two years, primarily for vacations, and it has been incredibly user-friendly, making my staying much easier  .</p>
