...
const Roomsfrom = () => {
  return (
    <div>
        <div>
     <div>
        <form class="flex flex-col items-center text-sm text-slate-800">
    ...
    <p class="max-md:text-sm text-gray-500 pb-10 text-center">
        Or just reach out manually to us at <a href="#" class="text-indigo-600 hover:underline">book@quickstay.com</a>
    </p>
    ...
    <div class="max-w-96 w-full px-4">
        ...
        <div class="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
            ...
            <input type="text" class="h-full px-2 w-full outline-none bg-transparent" placeholder="Enter your full name" required></input>
        </div>
        ...
        <div class="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
            ...
            <input type="email" class="h-full px-2 w-full outline-none bg-transparent" placeholder="Enter your email address" required></input>
        </div>
